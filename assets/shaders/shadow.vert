...
layout(location = 1) in vec4 a_model_matrix_row0;
layout(location = 2) in vec4 a_model_matrix_row1;
layout(location = 3) in vec4 a_model_matrix_row2;
layout(location = 4) in vec4 a_model_matrix_row3;
